...
data full; set data.final_harmonizedonly_040825; run;
...
/* Whole-body obesity */
/**********************/
%macro gee_wb(out, class, cont, type, dist, link, add);
proc genmod data=data_gee descending;
    class id_nffi wbobecat(ref='2') nffiyear_formatted &class./ param=ref;
    model &out. = wbobecat &class. &cont. &add. / dist=&dist. link=&link.;
...
*interaction;
%gee_wb(recurrentfall, studyno gender race educa smk curdrnk, ageint physactivity, ar(1), binomial, logit, wbobecat*gender);
...
*interaction;
%gee_wb(fallnumbers, studyno gender race educa smk curdrnk, ageint physactivity, ind, multinomial, cumlogit, wbobecat*gender);


/*********************/
/* Abdominal obesity */
/*********************/
%macro gee_ab(out, class, cont, type, dist, link, add);
proc genmod data=data_gee descending;
    class id_nffi abobe(ref='0') nffiyear_formatted &class./ param=ref;
    model &out. = abobe &class. &cont. &add. / dist=&dist. link=&link.;
    repeated subject=id_nffi / within=nffiyear_formatted type=&type. corrw;
...
*interaction;
%gee_ab(recurrentfall, studyno gender race educa smk curdrnk, height_baseline ageint physactivity, ar(1), binomial, logit, abobe*gender);
...
*interaction;
%gee_ab(fallnumbers, studyno gender race educa smk curdrnk, height_baseline ageint physactivity, ind, multinomial, cumlogit, abobe*gender);


/**********************/
/* Sarcopenic obesity */
/**********************/
%macro gee_so(out, class, cont, type, dist, link, add);
proc genmod data=data_gee descending;
    class id_nffi saobecat(ref='1') nffiyear_formatted &class./ param=ref;
    model &out. = saobecat &class. &cont. &add. / dist=&dist. link=&link.;
    repeated subject=id_nffi / within=nffiyear_formatted type=&type. corrw;
...
*interaction;
%gee_so(recurrentfall, studyno gender race educa smk curdrnk, ageint physactivity, ar(1), binomial, logit, saobecat*gender);
...
*interaction;
%gee_so(fallnumbers, studyno gender race educa smk curdrnk, ageint physactivity, ind, multinomial, cumlogit, saobecat*gender);
...
/* Wbole-body obesity */
%macro gee_wb_c(out, class, cont, type, dist, link, add);
...
%mend gee_wb_c;
*interaction;
%gee_wb_c(fallind, studyno gender race educa smk curdrnk, ageint physactivity, ar(1), binomial, logit, wbobecat*gender);


/* abdominal obesity */
%macro gee_ab_c(out, class, cont, type, dist, link, add);
proc genmod data=data_gee_complete descending;
    class id_nffi abobe(ref='0') nffiyear_formatted &class./ param=ref;
    model &out. = abobe &class. &cont. &add. / dist=&dist. link=&link.;
    repeated subject=id_nffi / within=nffiyear_formatted type=&type. corrw;
...
%mend gee_ab_c;
*interaction;
%gee_ab_c(fallind, studyno gender race educa smk curdrnk, height_baseline ageint physactivity, ar(1), binomial, logit, abobe*gender);


/* Sarcopenic obesity */
%macro gee_so_c(out, class, cont, type, dist, link, add);
proc genmod data=data_gee_complete descending;
    class id_nffi saobecat(ref='1') nffiyear_formatted &class./ param=ref;
    model &out. = saobecat &class. &cont. &add. / dist=&dist. link=&link.;
    repeated subject=id_nffi / within=nffiyear_formatted type=&type. corrw;
...
%mend gee_so_c;
*interaction;
%gee_so_c(fallind, studyno gender race educa smk curdrnk, ageint physactivity, ar(1), binomial, logit, saobecat*gender);

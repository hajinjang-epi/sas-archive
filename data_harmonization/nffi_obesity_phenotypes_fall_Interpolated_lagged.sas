...
libname created "Z:\Fall Injuries Combined Studies\Harmonization Coding\Analysis\Hajin's analysis\Interpolated\Interpolated_lagged";
...
%gee_wb_c(fallind, studyno gender race educa smk curdrnk, ageint physactivity, ar(1), binomial, logit);
...
%gee_ab_c(fallind, studyno gender race educa smk curdrnk, height_baseline ageint physactivity, ar(1), binomial, logit);
...
%gee_so_c(fallind, studyno gender race educa smk curdrnk, ageint physactivity, ar(1), binomial, logit);
